    ...
    ********************************/
    ...
    function callingNewSlide(opt, container) {
        ...
        if (bt.length > 0) {
            ...
            if (opt.videoplaying != true) bt.animate({
                'width': "100%"
            }, {
                duration: (opt.delay - 100),
                queue: false,
    ...
    function setBulPos(container, opt) {
        ...
        if (opt.navigationArrows != "none" && opt.navigationArrows != "nexttobullets") {
            ...
            if (opt.soloArrowLeftHalign == "left") tl.css({
                'left': (0 + opt.soloArrowLeftHOffset + loff) + "px"
            });
            if (opt.soloArrowLeftHalign == "right") tl.css({
                'right': (0 + opt.soloArrowLeftHOffset - loff) + "px"
            });
            ...
            if (opt.soloArrowRightHalign == "left") tr.css({
                'left': (0 + opt.soloArrowRightHOffset + loff) + "px"
            });
            if (opt.soloArrowRightHalign == "right") tr.css({
                'right': (0 + opt.soloArrowRightHOffset - loff) + "px"
            });
        ...
        if (vorh == "horizontal") {
            ...
            for (var i = 0; i < opt.slots; i++) {
                ...
                if (scalestart != undefined && rotatestart != undefined)
                    TweenLite.set(sh.find('.slot').last(), {
